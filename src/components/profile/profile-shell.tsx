  ...
  const followersLabel = (
    <div className="flex flex-wrap items-center gap-x-6 gap-y-3 pt-2">
      <button 
        ...
        className="group flex items-center gap-2 text-[14px] hover:opacity-80 transition-opacity focus:outline-none"
      >
      ...
      <div className="flex items-center gap-2 text-[14px] text-brown-muted font-medium">
